        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full bg-[#03C75A] text-white py-3 rounded-lg font-semibold hover:bg-[#02B350] transition flex items-center justify-center gap-3"
            >
            ...
            <button
              ...
              className="w-full bg-[#FEE500] text-black py-3 rounded-lg font-semibold hover:bg-[#FDD835] transition flex items-center justify-center gap-3"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
