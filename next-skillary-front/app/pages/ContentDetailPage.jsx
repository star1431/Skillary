...
import { mockContents, mockCreators, mockPlans, mockSubscriptions, mockPurchases } from '../utils/mockData';
...
export function ContentDetailPage({ contentId, onNavigate }) {
  ...
  const creator = content ? mockCreators.find((c) => c.id === content.creatorId) : null;
  ...
  const plans = mockPlans.filter((p) => p.creatorId === creator.id && p.isActive);
