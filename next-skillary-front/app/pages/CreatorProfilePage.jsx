...
import { mockCreators, mockPlans, mockContents } from '../utils/mockData';
...
export function CreatorProfilePage({ creatorId, onNavigate }) {
  ...
  const plans = mockPlans.filter((p) => p.creatorId === creatorId && p.isActive);
  const allContents = mockContents.filter((c) => c.creatorId === creatorId);
