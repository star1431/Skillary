...
import { mockContents, mockCreators, categories } from '../utils/mockData';
import { ArrowRight, TrendingUp, Star, Zap } from 'lucide-react';
import { ROUTES } from '../config/routes';

export function HomePage({ onNavigate }) {
  const featuredCreators = mockCreators.filter((c) => c.status === 'APPROVED').slice(0, 3);
  const popularContents = mockContents.slice(0, 4);
